...
%package        devel
Summary:        Development files for swiftagent
...
%doc README.md
%{_bindir}/swiftagent
%{_libdir}/libswiftagent_core.a
%{_libdir}/libswiftagent_tools.a
%{_libdir}/libswiftagent_llm.a

%files devel
%{_includedir}/swiftagent/
%{_libdir}/pkgconfig/swiftagent.pc

%changelog
* %{date} SwiftAgent Contributors <noreply@example.com> - 0.1.0-1
- Initial package
